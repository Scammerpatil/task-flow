...
const Page = () => {
  ...
  return (
    <section
      id="home"
      className="relative z-10 overflow-hidden bg-base-300 pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px] flex items-center justify-center max-h-[calc(100vh-5.8rem)] "
    >
          ...
          <div className="w-full px-4">
            ...
            >
              ...
              <p className="mb-12 text-base !leading-relaxed font-extralight text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                ...
                property owners and seekers. Explore verified listings, interact
                with agents, and book your dream space effortlessly. Whether
                you're searching for a cozy flat or a luxury apartment,
                GrihaSetu makes house hunting easier, smarter, and more
                intuitive.
              </p>
            </div>
